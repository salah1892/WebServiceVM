    ...
    <>
      ...
      <div className={StylesClasses.container}>
        <div style={{ display: "flex" }}>
            ...
            <Menu>
              ...
              <SubMenu label="Abonnements" icon={<SensorsIcon />}>
                <MenuItem
                  ...
                  onClick={() => handleSectionClick("Abonnee")}
                >
                  {" "}
                  Abonnée
                </MenuItem>
                <MenuItem
                  ...
                  onClick={() => handleSectionClick("Abonnement")}
                >
                  {" "}
                  Abonnements
                </MenuItem>
              ...
              <MenuItem
                ...
                onClick={() => handleSectionClick("Passager")}
              >
                Passager
              ...
              <MenuItem
                onClick={() => handleSectionClick("Payement")}
              ...
              >
                ...
                <MenuItem
                  onClick={() => handleSectionClick("ParametresPayement")}
          ...
          <div className={StylesClasses.content} style={{ width: "auto" }}>
            <section>
